...
public class ClientTest_NormalFunctionality {
    ...
    static Logger logger = Logger.getLogger(ClientTest_NormalFunctionality.class);


    public  static void main(String args[]) throws InterruptedException {
    	PropertyConfigurator.configure(ClientTest_NormalFunctionality.class.getResourceAsStream("log4j.info"));
		new Thread() {
...
//										Thread.sleep(3000);
                                        while(allUp){
                                            ...
                                            dataOutputStream.flush();
                                            if (dataInputStream.readUTF().trim().equalsIgnoreCase("5")) {
                                                allUp=false;
                                                break;
                                            }
                                            Thread.sleep(1000);
...
//
									...
									if(options.equalsIgnoreCase("2")){
                                        ...
                                        String subPacket = "82#0D#0001#" + "Test1,Test2,Test3,Test4,Test5" + "#00";
